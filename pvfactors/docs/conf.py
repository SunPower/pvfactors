# -*- coding: utf-8 -*-
#
# pvfactors documentation build configuration file, created by
# sphinx-quickstart on Wed Jun 15 15:51:17 2016.
#
...
version = '%s' % (pvfactors.__version__)
...
latex_documents = [
    (master_doc, 'pvfactors.tex', u'vf\\_model Documentation',
     u'Marc Anoma', 'manual'),
]
...
man_pages = [
    (master_doc, 'pvfactors', u'pvfactors Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pvfactors', u'pvfactors Documentation',
     author, 'pvfactors', 'One line description of project.',
     'Miscellaneous'),
]
